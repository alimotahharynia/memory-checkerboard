% Different square generator
function drawSquare = differentSquare(subject_ID, block, imageTest,...
...
% matching square color from random color function
squareColor = sqColor2;
...
imwrite(drawSquare, sprintf('%s_%d_%s_%d.jpg','Block',block, 'Different', imageTest));
cd(code_path)
